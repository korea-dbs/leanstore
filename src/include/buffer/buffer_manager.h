...
class BufferManager {
 public:
  ...
  void ConstructLocalRing();
  auto RetrieveLocalRing() -> struct io_uring &;
  ...
  auto BufferFramePage(pageid_t page_id) -> buffer::BufferFrame &;
 ...
 private:
  ...
  static constexpr u64 URING_NO_ENTRIES  = 64;
  ...
  BufferFrame *frame_;           /* The buffer frames of all stored pages */
  ExtentFrame *ext_frame_;       /* Buffer frame for extent pages */
