...
- Run clang-tidy on all files in the current working directory with a default
  set of checks and show warnings in the cc files and all project headers.
...
def main():
    ...
    # with origin/main, so as to speed up clang-tidy check.
    #
    ...
    if args.only_diff:
        ...
        # Get all files changed compared with origin/main
    ...
    try:
        ...
        if len(failed_files):
            ...
            print(
                "Note that a failing .h file will fail all the .cc files that include it.\n"
            )
